...
{
    public class PromotionCreatedParameter : BaseBackendParameter
    {
        [BindRequired]
        ...
        [DataType(DataType.DateTime, ErrorMessage = "START_DATE is datetime only.")]
        public DateTime? START_DATE { get; set; }

        [BindProperty(Name = "END_DATE", SupportsGet = true)]
        [DataType(DataType.DateTime, ErrorMessage = "END_DATE is datetime only.")]
